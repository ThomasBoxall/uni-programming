class Hash:
    ...
    def search(self, key):
        ...
        for i in range(10000):
            #This is an arbitrary stopping case, the most accurate one shouldbewhen all existing entries have been checked. #When the loops ehaust all non-empty entries
            address = (start + i * i) % len(self.hashTable)
